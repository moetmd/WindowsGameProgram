...
#define WINDOW_TITLE	L"D3Ddemo7"		//为窗口标题定义的宏
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance,LPSTR lpCmdLine, int nShowCmd)
{
	...
	wndClass.lpszClassName = L"D3Ddemo7";		//用一个以空终止的字符串，指定窗口类的名字。
	...
	//【3】窗口创建四步曲之三：正式创建窗口
	HWND hwnd = CreateWindow( L"D3Ddemo7",WINDOW_TITLE,		//喜闻乐见的创建窗口函数CreateWindow
	...
	//【6】窗口类的注销
	UnregisterClass(L"D3Ddemo7", wndClass.hInstance);  //程序准备结束，注销窗口类
	return 0;  
}
