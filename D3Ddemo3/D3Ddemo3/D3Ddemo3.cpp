...
VOID Direct3D_Render(HWND hwnd)
{
	...
	formatRect.top = 100;
	g_pFont->DrawText(0,_T("This is my first D3D program"),-1,&formatRect,DT_CENTER,D3DCOLOR_XRGB(60,60,60));

	formatRect.top = 250;
	g_pFont->DrawText(0,_T("DiaoDiaoDe"),-1,&formatRect,DT_CENTER,D3DCOLOR_XRGB(120,200,60));

	formatRect.top = 400;
	g_pFont->DrawText(0,_T("Shining Text ^_^"),-1,&formatRect,DT_CENTER,D3DCOLOR_XRGB(rand()%256,rand()%256,rand()%256));
